...
public interface CB_UI_Base_Settings
{
	...
	public static final SettingFolder SkinFolder = new SettingFolder("SkinFolder", SettingCategory.Folder, INVISIBLE, Config_Core.WorkPath
			+ "/skins/default", SettingStoreType.Global, SettingUsage.ACB);
	...
	public static final SettingInt FONT_SIZE_COMPASS_DISTANCE = new SettingInt("FONT_SIZE_COMPASS_DISTANCE", SettingCategory.Skin, EXPERT,
			27, SettingStoreType.Global, SettingUsage.ACB);
	...
	public static final SettingBool DebugSpriteBatchCountBuffer = new SettingBool("DebugSpriteBatchCountBuffer", SettingCategory.Debug,
			EXPERT, false, SettingStoreType.Global, SettingUsage.ACB);
	...
	public static final SettingFloat MapViewDPIFaktor = new SettingFloat("MapViewDPIFaktor", SettingCategory.Map, EXPERT,
			(float) Global.displayDensity, SettingStoreType.Global, SettingUsage.ACB);
	...
	public static final SettingFolder ImageCacheFolderLocal = new SettingFolder("ImageCacheFolderLocal", SettingCategory.Folder, NEVER,
			Config_Core.WorkPath + "/repository/cache", SettingStoreType.Local, SettingUsage.ACB);
	...
	public static final SettingColor LiveMapBackgroundColor = new SettingColor("LiveMapBackgroundColor", SettingCategory.LiveMap, NORMAL,
			new HSV_Color(0.8f, 0.8f, 1f, 1f), SettingStoreType.Global, SettingUsage.ACB);

	public static final SettingColor SolvedMysteryColor = new SettingColor("SolvedMysteryColor", SettingCategory.Skin, NORMAL,
			new HSV_Color(0.2f, 1f, 0.2f, 1f), SettingStoreType.Global, SettingUsage.ACB);
