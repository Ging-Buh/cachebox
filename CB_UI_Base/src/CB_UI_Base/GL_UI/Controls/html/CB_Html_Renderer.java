...
public class CB_Html_Renderer extends Renderer {
	...
	ELEMENT_HANDLERS.put(HTMLElementName.A, NOTIMPLEMENTED ? A_ElementHandler.INSTANCE : Not_implemented_ElementHandler.INSTANCE);
	...
	ELEMENT_HANDLERS.put(HTMLElementName.CENTER, NOTIMPLEMENTED ? StandardBlockElementHandler.INSTANCE_1_1 : Not_implemented_ElementHandler.INSTANCE);
	...
	ELEMENT_HANDLERS.put(HTMLElementName.H1, NOTIMPLEMENTED ? StandardBlockElementHandler.INSTANCE_2_1 : Not_implemented_ElementHandler.INSTANCE);
	ELEMENT_HANDLERS.put(HTMLElementName.H2, NOTIMPLEMENTED ? StandardBlockElementHandler.INSTANCE_2_1 : Not_implemented_ElementHandler.INSTANCE);
	ELEMENT_HANDLERS.put(HTMLElementName.H3, NOTIMPLEMENTED ? StandardBlockElementHandler.INSTANCE_2_1 : Not_implemented_ElementHandler.INSTANCE);
	ELEMENT_HANDLERS.put(HTMLElementName.H4, NOTIMPLEMENTED ? StandardBlockElementHandler.INSTANCE_2_1 : Not_implemented_ElementHandler.INSTANCE);
	ELEMENT_HANDLERS.put(HTMLElementName.H5, NOTIMPLEMENTED ? StandardBlockElementHandler.INSTANCE_2_1 : Not_implemented_ElementHandler.INSTANCE);
	ELEMENT_HANDLERS.put(HTMLElementName.H6, NOTIMPLEMENTED ? StandardBlockElementHandler.INSTANCE_2_1 : Not_implemented_ElementHandler.INSTANCE);
