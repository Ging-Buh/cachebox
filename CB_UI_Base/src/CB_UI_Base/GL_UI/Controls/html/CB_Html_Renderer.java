...
public class CB_Html_Renderer extends Renderer {
	...
	ELEMENT_HANDLERS.put(HTMLElementName.BLOCKQUOTE, IMPLEMENTED ? StandardBlockElementHandler.INSTANCE_1_1_INDENT : Not_implemented_ElementHandler.INSTANCE);
	...
	ELEMENT_HANDLERS.put(HTMLElementName.DD, IMPLEMENTED ? StandardBlockElementHandler.INSTANCE_0_0_INDENT : Not_implemented_ElementHandler.INSTANCE);
	...
	ELEMENT_HANDLERS.put(HTMLElementName.DT, IMPLEMENTED ? StandardBlockElementHandler.INSTANCE_0_0 : Not_implemented_ElementHandler.INSTANCE);
	...
	ELEMENT_HANDLERS.put(HTMLElementName.PRE, IMPLEMENTED ? PRE_ElementHandler.INSTANCE : Not_implemented_ElementHandler.INSTANCE);
