...
public class Linearlayout extends CB_View_Base
{
	...
	private LayoutChanged mLayoutChangedListner;

	public void setLayoutChangedListner(LayoutChanged listner)
	{
		mLayoutChangedListner = listner;
	}

	public void layout()
	{
		if (this.childs == null || this.childs.size() == 0) return; // gibt nix zu layouten
	 ...
	 * @param view
	 * @param margin
	 *            der Abstand zu den Oberen Item
	 * @return
	 */
	public GL_View_Base addChild(final GL_View_Base view, float margin)
	{
		if (sonderMargins == null) sonderMargins = new Hashtable<GL_View_Base, Float>();
