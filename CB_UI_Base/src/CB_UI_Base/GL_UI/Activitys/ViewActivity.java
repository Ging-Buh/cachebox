...
public class ViewActivity extends ActivityBase
{
	 ...
	 */
	public void setOnFinishListner(onFinishListener listener, boolean disposeView)
	{
	...
	public void finish()
	{
		...
		if (this.disposeViewWithFinish)
		{
			...
			this.view = null;
			if (this.btnClose != null) this.btnClose.dispose();
			this.btnClose = null;
		}
		else
		{ // must remove View from content !! otherwise view will be disposed with super.finish()
