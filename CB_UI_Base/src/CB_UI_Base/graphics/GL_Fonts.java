...
public class GL_Fonts
{
	...
	public static BitmapFont get(GL_FontFamily fontFamily, GL_FontStyle fontStyle, float textSize)
	{
		...
		if (fontFamily == null || fontStyle == null) return get_Default(GL_FontStyle.NORMAL, Size);
	...
	{
		if (DroidSerif_Bold.containsKey(textSize)) return DroidSerif_Bold.get(textSize);
	...
	{
		if (DroidSerif_BoldItalic.containsKey(textSize)) return DroidSerif_BoldItalic.get(textSize);
	...
	{
		if (DroidSerif_Italic.containsKey(textSize)) return DroidSerif_Italic.get(textSize);
	...
	{
		if (DroidSerif_Regular.containsKey(textSize)) return DroidSerif_Regular.get(textSize);
	...
	{
		if (Roboto_Regular.containsKey(textSize)) return Roboto_Regular.get(textSize);
	...
	{
		if (Roboto_Bold.containsKey(textSize)) return Roboto_Bold.get(textSize);
	...
	{
		if (Roboto_Italic.containsKey(textSize)) return Roboto_Italic.get(textSize);
	...
	{
		if (Roboto_BoldItalic.containsKey(textSize)) return Roboto_BoldItalic.get(textSize);
	...
	{
		if (DroidSans.containsKey(textSize)) return DroidSans.get(textSize);
	...
	{
		if (DroidSans_Bold.containsKey(textSize)) return DroidSans_Bold.get(textSize);
	...
	{
		if (DroidSansMono.containsKey(textSize)) return DroidSansMono.get(textSize);
