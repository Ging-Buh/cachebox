...
public class FontCache {
    ...
    public static BitmapFont get(GL_Paint.GL_FontFamily fontFamily, GL_Paint.GL_FontStyle fontStyle, float textSize) {
        return NORMAL.get(fontFamily, fontStyle, textSize);
    }

    public static BitmapFont get(boolean markUp, GL_Paint.GL_FontFamily fontFamily, GL_Paint.GL_FontStyle fontStyle, float textSize) {
        if (markUp) {
