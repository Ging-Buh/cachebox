...
class GL_Fonts {
    ...
    private BitmapFont get_DroidSerif_Bold(int textSize) {
        ...
        FileHandle fh = FileFactory.getInternalFileHandle("data/fonts/DroidSerif-Bold.ttf");
    ...
    private BitmapFont get_DroidSerif_BoldItalic(int textSize) {
        ...
        FileHandle fh = FileFactory.getInternalFileHandle("data/fonts/DroidSerif-BoldItalic.ttf");
        BitmapFont f = generateFont(fh, textSize);
    ...
    private BitmapFont get_DroidSerif_Italic(int textSize) {
        ...
        FileHandle fh = FileFactory.getInternalFileHandle("data/fonts/DroidSerif-Italic.ttf");
        BitmapFont f = generateFont(fh, textSize);
    ...
    private BitmapFont get_DroidSerif_Regular(int textSize) {
        ...
        FileHandle fh = FileFactory.getInternalFileHandle("data/fonts/DroidSerif-Regular.ttf");
        BitmapFont f = generateFont(fh, textSize);
    ...
    private BitmapFont get_Roboto_Regular(int textSize) {
        ...
        FileHandle fh = FileFactory.getInternalFileHandle("data/fonts/Roboto-Regular.ttf");
        BitmapFont f = generateFont(fh, textSize);
    ...
    private BitmapFont get_Roboto_Bold(int textSize) {
        ...
        FileHandle fh = FileFactory.getInternalFileHandle("data/fonts/Roboto-Bold.ttf");
        BitmapFont f = generateFont(fh, textSize);
    ...
    private BitmapFont get_Roboto_Italic(int textSize) {
        ...
        FileHandle fh = FileFactory.getInternalFileHandle("data/fonts/Roboto-Italic.ttf");
        BitmapFont f = generateFont(fh, textSize);
    ...
    private BitmapFont get_Roboto_BoldItalic(int textSize) {
        ...
        FileHandle fh = FileFactory.getInternalFileHandle("data/fonts/Roboto-BoldItalic.ttf");
        BitmapFont f = generateFont(fh, textSize);
    ...
    private BitmapFont get_DroidSans(int textSize) {
        ...
        FileHandle fh = FileFactory.getInternalFileHandle("data/fonts/DroidSans.ttf");
        BitmapFont f = generateFont(fh, textSize);
    ...
    private BitmapFont get_DroidSans_BoldItalic(int textSize) {
        ...
        FileHandle fh = FileFactory.getInternalFileHandle("data/fonts/DroidSans-BoldItalic.ttf");
        BitmapFont f = generateFont(fh, textSize);
    ...
    private BitmapFont get_DroidSans_Italic(int textSize) {
        ...
        FileHandle fh = FileFactory.getInternalFileHandle("data/fonts/DroidSans-Italic.ttf");
        BitmapFont f = generateFont(fh, textSize);
    ...
    private BitmapFont get_DroidSans_Bold(int textSize) {
        ...
        FileHandle fh = FileFactory.getInternalFileHandle("data/fonts/DroidSans-Bold.ttf");
        BitmapFont f = generateFont(fh, textSize);
    ...
    private BitmapFont get_DroidSansMono(int textSize) {
        ...
        FileHandle fh = FileFactory.getInternalFileHandle("data/fonts/DroidSansMono.ttf");
        BitmapFont f = generateFont(fh, textSize);
