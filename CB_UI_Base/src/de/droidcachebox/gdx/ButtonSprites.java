...
public class ButtonSprites {
     ...
     *
     * @param atlas    aus dem die Sprites gelesen werden
     * @param Normal   Name für das Normal Sprite
     * @param Pressed  Name für das Pressed Sprite
     * @param Disabled Name für das Disabled Sprite
     */
    ...
    public ButtonSprites(TextureAtlas atlas, String Normal, String Pressed, String Disabled, String Focus, int left, int right, int top, int bottom) {
        mPressed = new NinePatchDrawable(new NinePatch(atlas.findRegion(Pressed), left, right, top, bottom));
        mNormal = new NinePatchDrawable(new NinePatch(atlas.findRegion(Normal), left, right, top, bottom));
        mDisabled = new NinePatchDrawable(new NinePatch(atlas.findRegion(Disabled), left, right, top, bottom));
