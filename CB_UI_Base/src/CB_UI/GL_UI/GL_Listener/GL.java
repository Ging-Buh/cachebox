...
import CB_UI.GL_UI.Controls.SelectionMarker;
import CB_UI.GL_UI.Controls.SelectionMarker.Type;
...
public class GL implements ApplicationListener, InputProcessor
{
	...
	private CB_UI.GL_UI.Controls.Dialogs.Toast toast;
	...
	public void Toast(String string, int length)
	{
		if (toast == null)
		{
			toast = new CB_UI.GL_UI.Controls.Dialogs.Toast(new CB_RectF(0, 0, 100, GL_UISizes.BottomButtonHeight / 1.5f), "StringToast");
		}
