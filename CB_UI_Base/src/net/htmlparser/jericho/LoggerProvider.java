 ...
 * <p>
 * It is not usually necessary for users to create implementations of this interface, as several predefined instances are defined which
 * provide the most commonly required {@link Logger} implementations.
 * <p>
 * By default, a <code>LoggerProvider</code> is chosen automatically according to the algorithm described in the static
...
public interface LoggerProvider
{
	...
	/**
	 * A {@link LoggerProvider} implementation that wraps the standard <code>java.util.logging</code> system included in the Java SDK
	 * version 1.4 and above.
	 * <p>
	 * This is the default used if no other logging framework is detected. See the description of the static {@link Config#LoggerProvider}
	 ...
	 * <tr>
	 * <th>{@link Logger} level
	 * <th><code>java.util.logging.Level</code>
	 * <tr>
	 * <td>{@link Logger#error(String) ERROR}
	 * <td><code>SEVERE</code>
	 * <tr>
	 * <td>{@link Logger#warn(String) WARN}
	 * <td><code>WARNING</code>
	 * <tr>
	 * <td>{@link Logger#info(String) INFO}
	 * <td><code>INFO</code>
	 * <tr>
	 * <td>{@link Logger#debug(String) DEBUG}
	 * <td><code>FINE</code>
	 * </table>
	 */
	 ...
	 * <p>
	 * See the description of the static {@link Config#LoggerProvider} property for details on when this implementation is used as the
	 * default.
	 * <p>
	 * The following mapping of <a href="Logger.html#LoggingLevel">logging levels</a> is used:
	 * <table class="bordered" style="margin: 15px" cellspacing="0">
	 ...
	 * <p>
	 * The <code>name</code> argument is used by the underlying logging implementation, and is normally a dot-separated name based on the
	 ...
	 *
	 * @param name
	 *            the name of the logger, the use of which is determined by the underlying logging implementation, may be <code>null</code>.
