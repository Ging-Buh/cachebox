...
public class TestView extends CB_View_Base
{
	...
	public TestView(CB_RectF rec, String Name)
	{
		...
		// initial Image
		image = new Image(300, 600, 128, 128, "Test_Image");
	...
	private void requestLayout()
	{
		...
		if (info != null) info.setPos(new Vector2(margin, (float) (this.height - margin - info.getHeight())));
		if (togBtn != null) togBtn.setPos(new Vector2((float) (this.width - margin - togBtn.getWidth()), this.height - margin
				- togBtn.getHeight()));
