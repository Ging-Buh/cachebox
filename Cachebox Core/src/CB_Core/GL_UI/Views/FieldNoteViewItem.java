...
public class FieldNoteViewItem extends ListViewItemBackground
{
	...
	{
		lblGcCode = new Label(lblCacheName.getX(), lblCacheName.getY() - MeasuredLabelHeight - Dialog.getMargin(), this.width
				- ivCacheType.getMaxX() - (Dialog.getMargin() * 2), MeasuredLabelHeight, "");
	...
	{
		lblComment = new Label(getLeftWidth() + Dialog.getMargin(), 0, this.width - getLeftWidth() - getRightWidth()
				- (Dialog.getMargin() * 2), this.height - (this.height - lblGcCode.getY()) - Dialog.getMargin(), "");
