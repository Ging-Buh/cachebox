...
public class MoveableList<T> extends ArrayList<T>
{
    ...
    /// <para>Das Event <see cref="Changed">[Changed]</see>  wird ausgelösst.</para>
    /// <para><b>Das Event <see cref="Changed">[Changed]</see>  wird NICHT ausgelösst, wenn Step = 0 ist oder das Ergebniss dem Index entspricht. 
    ...
    /// (Wenn sich die List(Of T) nicht geändert hat.)</b></para>
    /// </remarks>
    public void MoveItem(int index) { this.MoveItem(index, 1); }
    ...
    private int ChkNewPos(int Pos) { return this.ChkNewPos(Pos, false); }
    ...
    /// wird die Eigenschaft <see cref="MoveResultIndex">[MoveResultIndex]</see> auf <b>-1</b> gesetzt, <b>da alle Items bewegt wurden.</b> </remarks>
