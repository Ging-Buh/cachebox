...
import CB_Core.GL_UI.Controls.Dialogs.PasswortDialog;
import CB_Core.GL_UI.Controls.Dialogs.PasswortDialog.returnListner;
...
public class GcApiLogin
{
	...
	public void RunRequest()
	{
		...
		if (lastCall != 0 && lastCall - System.currentTimeMillis() < 100) return;// entprellen!
	...
	private void Call_OAuth_Page(String URL) throws ClientProtocolException, IOException
	{
		...
		for (int i = 0; i < cookies.size(); i++)
		{
			...
			if (cookies.get(i).getDomain().equalsIgnoreCase("geopt.sytes.net")) GeoPtCookie = cookies.get(i);
		}
