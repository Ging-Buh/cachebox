...
public enum CacheTypes {
	...
	public static CacheTypes parseString(String string) {
		...
		if (string.toLowerCase().equals("unknown"))
			string = "Mystery";
		...
		if (string.toLowerCase().equals("webcam"))
			string = "Camera";
		if (string.toLowerCase().equals("question"))
			string = "MultiQuestion";
		if (string.toLowerCase().equals("reference"))
			string = "ReferencePoint";
		if (string.toLowerCase().equals("parking"))
			string = "ParkingArea";
		if (string.toLowerCase().equals("stages"))
			string = "MultiStage";
