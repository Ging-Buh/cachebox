...
public class Abstract_ShowCompassAction extends AbstractShowAction {
    private static Abstract_ShowCompassAction that;

    private Abstract_ShowCompassAction() {
        super("Compass", MenuID.AID_SHOW_COMPASS);
    }

    public static Abstract_ShowCompassAction getInstance() {
        if (that == null) that = new Abstract_ShowCompassAction();
        return that;
    }
