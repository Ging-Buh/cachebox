...
public class Abstract_ShowLogAction extends AbstractShowAction {

    private static Abstract_ShowLogAction that;
    ...
    private Abstract_ShowLogAction() {
        super("ShowLogs", MenuID.AID_SHOW_LOGS);
        // createContextMenu(); todo see getContextMenu
    }

    public static Abstract_ShowLogAction getInstance() {
        if (that == null) that = new Abstract_ShowLogAction();
        return that;
    }
