 ...
 * @author Longri
 */
public class Abstract_ShowMap extends AbstractShowAction {
    private static final String log = "Abstract_ShowMap";
    private static Abstract_ShowMap that;
    ...
    public static Abstract_ShowMap getInstance() {
        if (that == null) that = new Abstract_ShowMap();
        return that;
    }
