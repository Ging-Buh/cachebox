...
/**
 * Empf�ngt alle Positions �nderungen und sortiert Liste oder spielt Sounds ab.
 * 
 * @author Longri
 */
	...
	public void PositionChanged()
	{
		...
		if (newLocationThread == null) newLocationThread = new Thread(new Runnable()
		{
			...
			public void run()
			{
				...
				try
				{
					// schau die 50 n�chsten Caches durch, wenn einer davon n�her ist
					// als der aktuell n�chste -> umsortieren und raus
