...
public interface CB_UI_Settings {
	...
	public static final SettingString mapsforgeThemesStyle = new SettingString("mapsforgeThemesStyle", SettingCategory.Map, NORMAL, "", SettingStoreType.Global, SettingUsage.ACB);
	// int
