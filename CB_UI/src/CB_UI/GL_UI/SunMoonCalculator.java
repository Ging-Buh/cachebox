...
public class SunMoonCalculator {
    ...
    //TODO optimize Code! Replace RAD_TO_DEG with MathUtils... Update Time without new instance
    ...
    public SunMoonCalculator(Calendar calender, double lon, double lat) throws Exception {
        this(calender.get(Calendar.YEAR), calender.get(Calendar.MONTH) + 1, calender.get(Calendar.DAY_OF_MONTH),
                calender.get(Calendar.HOUR_OF_DAY), calender.get(Calendar.MINUTE), 0, lon * DEG_TO_RAD, lat * DEG_TO_RAD);
    }
