...
public class PresetListView extends V_ListView {
	...
	addPresetItem(SpriteCacheBase.getThemedSprite("GrabTB"), Translation.Get("GrabTB"), FilterInstances.WITHTB);
	addPresetItem(SpriteCacheBase.getThemedSprite("DropTB"), Translation.Get("DropTB"), FilterInstances.DROPTB);
