...
public class GlobalCore extends CB_UI_Base.Global implements SolverCacheInterface {
    ...
    public static final int CurrentRevision = 20160218;
	...
	wd = CancelWaitDialog.ShowWait(Translation.Get("chkApiState"), DownloadAnimation.GetINSTANCE(), new IcancelListener() {
	    ...
	    @Override public void isCanceld() {
		// TODO Handle Cancel
    ...
    @Override protected String getVersionPrefix() {
    ...
    @Override public Cache sciGetSelectedCache() {
	return getSelectedCache();
    }

    @Override public void sciSetSelectedCache(Cache cache) {
	setSelectedCache(cache);
	CacheListChangedEventList.Call();
    }

    @Override public void sciSetSelectedWaypoint(Cache cache, Waypoint waypoint) {
	setSelectedWaypoint(cache, waypoint);
	CacheListChangedEventList.Call();
    }

    @Override public Waypoint sciGetSelectedWaypoint() {
