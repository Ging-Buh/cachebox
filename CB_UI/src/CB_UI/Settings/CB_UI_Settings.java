...
public interface CB_UI_Settings
{
	...
	public static final SettingBool CacheMapData = new SettingBool("CacheMapData", SettingCategory.Internal, INVISIBLE, false, SettingStoreType.Global, SettingUsage.ACB);
	public static final SettingBool CacheImageData = new SettingBool("CacheImageData", SettingCategory.Internal, INVISIBLE, true, SettingStoreType.Global, SettingUsage.ACB);
	public static final SettingBool CacheSpoilerData = new SettingBool("CacheSpoilerData", SettingCategory.Internal, INVISIBLE, true, SettingStoreType.Global, SettingUsage.ACB);
	public static final SettingBool SuppressPowerSaving = new SettingBool("SuppressPowerSaving", SettingCategory.Misc, NORMAL, true, SettingStoreType.Global, SettingUsage.ACB);
	...
	public static final SettingBool DeleteLogs = new SettingBool("DeleteLogs", SettingCategory.Internal, INVISIBLE, false, SettingStoreType.Global, SettingUsage.ACB);
	public static final SettingBool CompactDB = new SettingBool("CompactDB", SettingCategory.Internal, INVISIBLE, false, SettingStoreType.Global, SettingUsage.ACB);
	...
	// int
	public static final SettingInt LogMaxMonthAge = (SettingInt) SettingsList.addSetting(new SettingInt("LogMaxMonthAge", SettingCategory.Internal, INVISIBLE, 6, SettingStoreType.Global, SettingUsage.ACB));
	public static final SettingInt LogMinCount = (SettingInt) SettingsList.addSetting(new SettingInt("LogMinCount", SettingCategory.Internal, INVISIBLE, 99999, SettingStoreType.Global, SettingUsage.ACB));
	...
	public static final SettingInt VibrateTime = (SettingInt) SettingsList.addSetting(new SettingInt("VibrateTime", SettingCategory.Misc, NORMAL, 20, SettingStoreType.Global, SettingUsage.ACB));
	...
	public static final SettingInt MapMaxCachesLabel = (SettingInt) SettingsList.addSetting(new SettingInt("MapMaxCachesLabel", SettingCategory.Map, INVISIBLE, 12, SettingStoreType.Global, SettingUsage.ACB));
	public static final SettingInt MapMaxCachesDisplay_config = (SettingInt) SettingsList.addSetting(new SettingInt("MapMaxCachesDisplay_config", SettingCategory.Map, INVISIBLE, 10000, SettingStoreType.Global, SettingUsage.ACB));
	public static final SettingInt mapMaxCachesDisplayLarge_config = (SettingInt) SettingsList.addSetting(new SettingInt("mapMaxCachesDisplayLarge_config", SettingCategory.Map, INVISIBLE, 75, SettingStoreType.Global, SettingUsage.ACB));
	...
	public static final SettingInt LastMapToggleBtnState = (SettingInt) SettingsList.addSetting(new SettingInt("LastMapToggleBtnState", SettingCategory.Map, INVISIBLE, 0, SettingStoreType.Global, SettingUsage.ACB));
	...
	public static final SettingString NavigationProvider = (SettingString) SettingsList.addSetting(new SettingString("NavigationProvider", SettingCategory.Internal, INVISIBLE, "http://openrouteservice.org/php/OpenLSRS_DetermineRoute.php", SettingStoreType.Global, SettingUsage.ACB));
	...
	public static final SettingString SpoilersDescriptionTags = (SettingString) SettingsList.addSetting(new SettingString("SpoilersDescriptionTags", SettingCategory.Internal, INVISIBLE, "", SettingStoreType.Global, SettingUsage.ACB));
	public static final SettingString quickButtonList = (SettingString) SettingsList.addSetting(new SettingString("quickButtonList", SettingCategory.QuickList, INVISIBLE, "5,0,1,3,2", SettingStoreType.Global, SettingUsage.ACB));
	...
	public static final SettingIntArray OsmMaxImportLevel = new SettingIntArray("OsmMaxImportLevel", SettingCategory.Map, INVISIBLE, 16, SettingStoreType.Global, SettingUsage.ACB, LocatorSettings.Level);
	...
	public static final SettingsAudio Approach = new SettingsAudio("Approach", SettingCategory.Sounds, NORMAL, new Audio("data/sound/Approach.ogg", false, false, 1.0f), SettingStoreType.Global, SettingUsage.ACB);
	public static final SettingsAudio GPS_lose = new SettingsAudio("GPS_lose", SettingCategory.Sounds, NORMAL, new Audio("data/sound/GPS_lose.ogg", false, false, 1.0f), SettingStoreType.Global, SettingUsage.ACB);
	public static final SettingsAudio GPS_fix = new SettingsAudio("GPS_fix", SettingCategory.Sounds, NORMAL, new Audio("data/sound/GPS_Fix.ogg", false, false, 1.0f), SettingStoreType.Global, SettingUsage.ACB);
	public static final SettingsAudio AutoResortSound = new SettingsAudio("AutoResortSound", SettingCategory.Sounds, NORMAL, new Audio("data/sound/AutoResort.ogg", false, false, 1.0f), SettingStoreType.Global, SettingUsage.ACB);
	...
	public static final SettingBool AppRaterDontShowAgin = new SettingBool("AppRaterDontShowAgin", SettingCategory.RememberAsk, NORMAL, false, SettingStoreType.Platform, SettingUsage.ACB);
