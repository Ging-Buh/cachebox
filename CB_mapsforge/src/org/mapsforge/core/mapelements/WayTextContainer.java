...
public class WayTextContainer extends MapElementContainer {
    ...
    public WayTextContainer(Point[][] coordinates, Point point, Point end, Display display, int priority, String text, Paint paintFront, Paint paintBack, double textHeight) {
