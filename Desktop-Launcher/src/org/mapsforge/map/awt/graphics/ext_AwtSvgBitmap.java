...
class ext_AwtSvgBitmap extends ext_AwtResourceBitmap {
    static final float DEFAULT_SIZE = 400f;

    ext_AwtSvgBitmap(InputStream inputStream, int hash, float scaleFactor, int width, int height, int percent) throws IOException {
        super(getResourceBitmap(inputStream, hash, scaleFactor, width, height, percent));
    }

    private static BufferedImage getResourceBitmap(InputStream inputStream, int hash, float scaleFactor, int width, int height, int percent) throws IOException {
