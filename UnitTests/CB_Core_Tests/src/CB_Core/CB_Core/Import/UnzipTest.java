...
public class UnzipTest extends TestCase {
	...
	public static void testUnzip() throws Exception {
		...
		File directory = FileFactory.createFile("./testdata/gpx/");
		...
		ArrayList<File> ordnerInhalt = FileIO.recursiveDirectoryReader(FileFactory.createFile("./testdata/gpx/GS_PQ/"), new ArrayList<File>());
		int counter = 0;
		for (File tmp2 : ordnerInhalt) {
