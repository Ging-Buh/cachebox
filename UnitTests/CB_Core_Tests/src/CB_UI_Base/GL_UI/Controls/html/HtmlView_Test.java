...
public class HtmlView_Test {
    ...
    @Test
    public void listElementHandlerTest() {
        Source source = new CB_FormatedHtmlSource(HTMLSOURCE_6);
        CB_Html_Renderer renderer = new CB_Html_Renderer(source);
        List<Html_Segment> segmentList = renderer.getElementList();
    ...
    @Test
    public void TableElementHandlerTest() {
        Source source = new CB_FormatedHtmlSource(HTMLSOURCE_TABLE);
        CB_Html_Renderer renderer = new CB_Html_Renderer(source);
        List<Html_Segment> segmentList = renderer.getElementList();
