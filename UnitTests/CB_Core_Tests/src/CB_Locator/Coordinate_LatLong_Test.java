...
public class Coordinate_LatLong_Test extends TestCase {
	...
	public void testStringConstructors() {
		String[] strings = new String[] { "52� 33,355N / 13� 24,873E", "N52� 33,355 / E13� 24,873", "N 52� 33,355 / E 13� 24,873", "N 52� 33.355 / E 13� 24.873", "52� 33,355n / 13� 24,873e", "n52� 33,355 / e13� 24,873", "n 52� 33,355 / e 13� 24,873",
				"n 52� 33.355 / e 13� 24.873", "52� 33,355N / 13� 024,873E", "N52� 33,355 / E013� 24,873", "N 52� 33,355 / E 013� 24,873", "S 52� 33.355 / W 013� 24.873", "52� 33,355S / 13� 24,873W", "S52� 33,355 / W13� 24,873",
				"S 52� 33,355 / W 13� 24,873", "S 52� 33.355 / W 13� 24.873", "52� 33,355S / 13� 24,873W", "S52� 33,355 / W13� 24,873", "S 52� 33,355 / W 13� 24,873", "S 52� 33.355 / W 13� 24.873", "52� 33,355S / 13� 024,873W",
		...
		Coordinate[] expectedCoord = new Coordinate[] { new Coordinate(52555916, 13414550), new Coordinate(52555916, 13414550), new Coordinate(52555916, 13414550), new Coordinate(52555916, 13414550), new Coordinate(52555916, 13414550),
				new Coordinate(52555916, 13414550), new Coordinate(52555916, 13414550), new Coordinate(52555916, 13414550), new Coordinate(52555916, 13414550), new Coordinate(52555916, 13414550), new Coordinate(52555916, 13414550),
				new Coordinate(-52555916, -13414550), new Coordinate(-52555916, -13414550), new Coordinate(-52555916, -13414550), new Coordinate(-52555916, -13414550), new Coordinate(-52555916, -13414550), new Coordinate(-52555916, -13414550),
				new Coordinate(-52555916, -13414550), new Coordinate(-52555916, -13414550), new Coordinate(-52555916, -13414550), new Coordinate(-52555916, -13414550), new Coordinate(-52555916, -13414550), new Coordinate(-52555916, -13414550),
				new Coordinate(-52555916, -13414550) };
	...
	private void assertCoordDistance(Coordinate coord1, Coordinate coord2, CalculationType calcType, int exspectedDistance, int tolerance) {
		...
		MathUtils.computeDistanceAndBearing(calcType, coord1.getLatitude(), coord1.getLongitude(), coord2.getLatitude(), coord2.getLongitude(), dist);
		...
		if (calcType == CalculationType.FAST) {
			if ((dist[0] < 300 || dist[0] > 1000) && (dist[0] < 5000 || dist[0] < 10000)) {
				...
				MathUtils.computeDistanceAndBearing(CalculationType.ACCURATE, coord1.getLatitude(), coord1.getLongitude(), coord2.getLatitude(), coord2.getLongitude(), distAccurate);
