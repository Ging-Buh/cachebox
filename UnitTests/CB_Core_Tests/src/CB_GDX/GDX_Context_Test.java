...
public class GDX_Context_Test extends TestCase {
	...
	public void testdefaultDE() {
		...
		assertEquals("Koordinaten des Breitengrads f�r den ersten Kartenaufruf", Translation.Get("Desc_MapInitLatitude"));
	...
	public void testdefaultFr() {
		...
		assertEquals("Fran�ais", Translation.Get("lang".hashCode()));

		assertEquals("Journal", Translation.Get("ShowLogs".hashCode()));

		assertEquals("Cr�ation d'une PQ erron�e!", Translation.Get("ErrCreatePQ".hashCode()));
	...
	public void testWithParameter() {
		InitTestDBs.InitialTranslations("de");
		assertEquals("Die FieldNote" + br + br + "[Param1]" + br + br + " von Trackable" + br + br + "[Param2] wirklich l�schen?", Translation.Get("confirmFieldnoteDeletionTB", "Param1", "Param2"));

		assertEquals("Fehler: Funktion Param1/Parameter Param2 (Param3) ist keine g�ltige Param4: [Param5]", Translation.Get("solverErrParamType", "Param1", "Param2", "Param3", "Param4", "Param5"));
