...
public enum Attributes {
	...
	public static Attributes getAttributeEnumByGcComId(int id) {
		switch (id) {
			...
			case 46:
				return CB_Core.Enums.Attributes.Truck_Driver_RV;
			case 47:
	...
	private static void ini() {
		...
		attributeLookup.put(Attributes.Truck_Driver_RV, 46);
