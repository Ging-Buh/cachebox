...
{
  Default,  Dogs, Access_or_parking_fee, Climbing_gear, Boat, Scuba_gear, Recommended_for_kids, Takes_less_than_an_hour, Scenic_view, Significant_Hike, Difficult_climbing, May_require_wading, May_require_swimming, Available_at_all_times, Recommended_at_night, Available_during_winter, Cactus, Poison_plants, Dangerous_Animals, Ticks, Abandoned_mines, Cliff_falling_rocks, Hunting, Dangerous_area, Wheelchair_accessible, Parking_available, Public_transportation, Drinking_water_nearby, Public_restrooms_nearby, Telephone_nearby, Picnic_tables_nearby, Camping_available, Bicycles, Motorcycles, Quads, Off-road_vehicles, Snowmobiles, Horses, Campfires, Thorns, Stealth_required, Stroller_accessible, Needs_maintenance, Watch_for_livestock, Flashlight_required, Lost_And_Found_Tour, Truck_Driver/RV, Field_Puzzle, UV_Light_Required, Snowshoes, Cross_Country_Skis, Special_Tool_Required, Night_Cache, Park_and_Grab, Abandoned_Structure, Short_hike_), Medium_hike_), Long_Hike_), Fuel_Nearby, Food_Nearby, Wireless_Beacon, Partnership_Cache, Seasonal_Access, Tourist_Friendly, Tree_Climbing, Front_Yard_), Teamwork_Required, GeoTour;
...
case 35:
return CB_Core.Enums.Attributes.Off-road_vehicles;
case 36:
...
case 46:
return CB_Core.Enums.Attributes.Truck_Driver/RV;
case 47:
...
case 55:
return CB_Core.Enums.Attributes.Short_hike_);
case 56:
return CB_Core.Enums.Attributes.Medium_hike_);
case 57:
return CB_Core.Enums.Attributes.Long_Hike_);
case 58:
...
case 65:
return CB_Core.Enums.Attributes.Front_Yard_);
case 66:
...
private static void ini()
{
	...
	attributeLookup.put(Attributes.Off-road_vehicles, 35);
	...
	attributeLookup.put(Attributes.Truck_Driver/RV, 46);
	...
	attributeLookup.put(Attributes.Short_hike_), 55);
	attributeLookup.put(Attributes.Medium_hike_), 56);
	attributeLookup.put(Attributes.Long_Hike_), 57);
	...
	attributeLookup.put(Attributes.Front_Yard_), 65);
