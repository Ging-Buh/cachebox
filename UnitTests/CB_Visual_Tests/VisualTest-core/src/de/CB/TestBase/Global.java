...
public class Global extends CB_UI_Base.Global
{
	...
	public static final String AboutMsg = "freizeitkarte-osm (2013)" + br + "www.freizeitkarte-osm.de" + br + "developed by:" + br
			+ "SammysHP (c:geo)" + br + "Longri (Cachebox)" + br + "On behalf of" + br + "freizeitkarte-osm";
