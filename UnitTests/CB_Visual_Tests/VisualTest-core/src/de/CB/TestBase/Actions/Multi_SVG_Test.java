...
public class Multi_SVG_Test extends ArrayList<TestCaseBase> {
	...
	String[] NameListWithPNG = new String[] { "matrixTrans", "strokes", "pathArc", "transformations", "cubicPath", "matrix", "gradients", "shapes" };

	String[] NameList = new String[] { "atm", "cafe", "bakery", "airport", "alpine_hut", "bank", "bench", "bicycle_rental", "bus", "bus_sta", "campSite" };
