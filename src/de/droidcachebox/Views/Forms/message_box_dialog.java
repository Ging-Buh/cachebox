...
public class message_box_dialog extends android.app.Dialog {
 
    public message_box_dialog(Context context, int theme) {
        super(context, theme);
    }
 
    public message_box_dialog(Context context) {
        super(context);
    }
    ...
    public static class Builder {
         ...
         */
        public message_box_dialog create() {
            LayoutInflater inflater = (LayoutInflater) context
                    .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            // instantiate the dialog with the custom Theme
            final message_box_dialog dialog = new message_box_dialog(context, 
            		R.style.Dialog);
