...
public final class CacheInfoControl extends View
{
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec)
	{
		...
		/*
		 * int widthMode = MeasureSpec.getMode(widthMeasureSpec); int widthSize = this.width = MeasureSpec.getSize(widthMeasureSpec);
		 * 
		 * int heightMode = MeasureSpec.getMode(heightMeasureSpec); int heightSize = this.height = MeasureSpec.getSize(heightMeasureSpec);
		 */
	...
	private int measureWidth(int measureSpec)
	{
		...
		{
			// Measure the text
			result = (int) Global.Paints.Day.ListBackground.measureText(aktCache.Name) + getPaddingLeft() + getPaddingRight();
