...
public class Android_FileExplorer_XPlore extends CB_FileExplorer_Base {
	...
	public boolean getFile(String initialPath, String extension, String TitleText, String ButtonText, IgetFileReturnListener returnListener) {
		...
		try {
			CB_Android_FileExplorer.UsedActivity.startActivityForResult(in, Global.REQUEST_CODE_PICK_FILE_OR_DIRECTORY_FROM_PLATFORM_CONECTOR);
			return true;
	...
	public static CB_FileExplorer_Base getMyInstanz() {
		if (that == null)
			that = new Android_FileExplorer_XPlore();
		return that;
	}
