...
public class AndroidSettings {
	...
	public static final SettingBool RunOverLockScreen = new SettingBool("RunOverLockScreen", SettingCategory.Misc, NORMAL, true, SettingStoreType.Global, SettingUsage.ACB);
