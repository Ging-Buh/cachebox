...
public class MapCacheList
{
	...
	private int zoom = 15;
	public ArrayList<WaypointRenderInfo> list = new ArrayList<MapCacheList.WaypointRenderInfo>();
	...
	public MapCacheList(int maxZoomLevel)
	{
		super();
			...
			try
			{
				do
				{
					if (state.compareAndSet(1, 2))
					{
						...
						tmplist = new ArrayList<MapCacheList.WaypointRenderInfo>();
