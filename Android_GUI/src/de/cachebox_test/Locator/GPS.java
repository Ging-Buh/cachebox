...
public class GPS 
{
	...
	public static int getVisibleSats(){return mSatVisible;}
	public static int getFixedSats(){return mSatFixed;}
	public static ArrayList<GpsStrength> getSatList(){return mSatList;}
	public static String getSatAndFix(){return String.valueOf(mSatVisible) + "/" +  String.valueOf(mSatFixed);}
	...
	public static void setSatStrength(View strengthView, View[] retBalken)
	{
		...
		int count=0;
		if(de.cachebox_test.Locator.GPS.getSatList()!=null)
		{
			for (GpsStrength tmp : de.cachebox_test.Locator.GPS.getSatList())
			{
