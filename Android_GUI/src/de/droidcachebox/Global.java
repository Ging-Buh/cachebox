...
public class Global{
    public static final int CurrentRevision = 409;
...
//    public static Coordinate Marker = new Coordinate();
     ...
     * 			<br>Index 0 =<img src="doc-files/night_tb.png" width=32 height=32> <img src="doc-files/day_tb.png" width=32 height=32>
        		...
        		<br>Index 40 =<img src="doc-files/night_slider_down.png" width=32 height=32> <img src="doc-files/day_slider_down.png" width=32 height=32>
        		<br>Index 41 =<img src="doc-files/night_slider_up_down.png" width=32 height=32> <img src="doc-files/day_slider_up_down.png" width=32 height=32>
     */
...
//	        };
	        ...
	        BtnIcons = new Drawable[] 
	                                { 
	                	        		...
	                	        		getDrawable(R.drawable.list_icon, res), //TrackListView braucht noch ein Icon
	                	        		getDrawable(R.drawable.log10, res),
	                	        		getDrawable(R.drawable.video_icon, res),
	                	        		getDrawable(R.drawable.voice_rec_icon, res),
	                	        		getDrawable(R.drawable.star, res), //Live search braucht noch ein Icon
    ...
    private static int[] colorAttrs = new int[]
       {R.attr.ListBackground, R.attr.ListBackground_secend, 
    	...
    	R.attr.Compass_faceColorFilter,
    	R.attr.Compass_TextColor,
    	R.attr.Compass_N_TextColor,
    	R.attr.Map_Compass_TextColor,
