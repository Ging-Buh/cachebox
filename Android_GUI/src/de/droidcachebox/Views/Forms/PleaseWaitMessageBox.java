...
public class PleaseWaitMessageBox extends android.app.Dialog {
	...
	public static Dialog CreateDialog(int dialogId, Bundle b) 
	{
    	...
    	switch (dialogId) 
    	{
	    	case DialogID.MSG_BOX_1 :
	    		PleaseWaitMessageBox.Builder customBuilder = new
	    		PleaseWaitMessageBox.Builder(getActivity());
	    	...
	    	case DialogID.MSG_BOX_2 :
	    		PleaseWaitMessageBox.Builder customBuilder2 = new
	    		PleaseWaitMessageBox.Builder(getActivity());
			...
			setButtonCaptions(b);
	    		PleaseWaitMessageBox.Builder customBuilder3 = new
	    		PleaseWaitMessageBox.Builder(getActivity());
	    	...
	    	case DialogID.MSG_BOX_4 :
				...
				setButtonCaptions(b);
				setIcon(b); 
		    		PleaseWaitMessageBox.Builder customBuilder4 = new
		    		PleaseWaitMessageBox.Builder(getActivity());
    ...
    public static class Builder {
        ...
        public PleaseWaitMessageBox create() {
            ...
            final PleaseWaitMessageBox dialog = new PleaseWaitMessageBox(context, 
            		R.style.Dialog);
