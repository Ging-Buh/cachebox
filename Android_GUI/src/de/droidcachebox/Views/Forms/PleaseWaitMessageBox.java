 ...
 * Informationen und Anweisungen für den Benutzer enthalten kann. Entspricht in
 * etwa der C# .NET Klasse. Da nicht auf ein Result gewartet werden kann, muss
 * ein DialogInterface.OnClickListener() übergeben werden.
 * 
...
public class PleaseWaitMessageBox extends android.app.Dialog
{
	 ...
	 * standardmäßig die Schaltfläche OK angezeigt. Das Meldungsfeld enthält
	 ...
	 * Beschriftung an. Im Meldungsfeld wird standardmäßig die Schaltfläche OK
	 * angezeigt. Das Meldungsfeld enthält kein Icon.
	 * 
	 * @param msg
	 ...
	 *            Der in der Titelleiste des Meldungsfelds anzuzeigende Text.
	 * @param buttons
	 *            Ein MessageBoxButtons-Wert, der angibt, welche Schaltflächen
