...
public class StringInputBox extends android.app.Dialog
{
	 ...
	 * </pre>
	 */
	public static void Show(String title, String msg, String InitialValue, DialogInterface.OnClickListener Listener)
	{
	...
	public static void Show(String title, String msg, String InitialValue, DialogInterface.OnClickListener Listener, Activity activity)
	{
		listner = Listener;
		Bundle b = new Bundle();
		b.putString("msg", msg);
		...
		StringInputBox.Builder customBuilder = new StringInputBox.Builder(activity);
		customBuilder.setTitle(b.getString("title")).setMessage(b.getString("msg")).setValue(b.getString("iniValue"))
	...
	public static class Builder
	{
		...
		public StringInputBox create()
		{
			...
			final StringInputBox dialog = new StringInputBox(context, R.style.Dialog);
			View layout = inflater.inflate(R.layout.string_inputbox_layout, null);
