...
public class Waypoint implements Serializable
{
	...
	// / Id des dazugeh�rigen Caches in der Datenbank von geocaching.com
	public long CacheId;
	...
	// True wenn dies der Startpunkt f�r den n�chsten Besuch ist.
	// Das CacheIcon wird dann auf diesen Waypoint verschoben und dieser Waypoint wird standardm��ig aktiviert
	...
	// / <summary>
	// / Entfernung von der letzten g�ltigen Position
	// / </summary>
