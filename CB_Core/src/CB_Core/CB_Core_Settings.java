...
public interface CB_Core_Settings {
    ...
    public static final SettingInt connection_timeout = new SettingInt("conection_timeout", SettingCategory.Internal, DEVELOPER, 10000, SettingStoreType.Global, SettingUsage.ALL);
    ...
    public static final SettingBool FieldNotesLoadAll = new SettingBool("FieldNotesLoadAll", SettingCategory.Fieldnotes, DEVELOPER, false, SettingStoreType.Global, SettingUsage.ACB);
    public static final SettingInt FieldNotesLoadLength = new SettingInt("FieldNotesLoadLength", SettingCategory.Fieldnotes, DEVELOPER, 10, SettingStoreType.Global, SettingUsage.ACB);
