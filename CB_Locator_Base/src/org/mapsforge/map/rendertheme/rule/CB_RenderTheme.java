...
public class CB_RenderTheme {
	...
	private final LRUCache<CB_MatchingCacheKey, List<RenderInstruction>> matchingCache;
	...
	CB_RenderTheme(CB_RenderThemeBuilder renderThemeBuilder) {
		...
		this.matchingCache = new LRUCache<CB_MatchingCacheKey, List<RenderInstruction>>(MATCHING_CACHE_SIZE);
	}
