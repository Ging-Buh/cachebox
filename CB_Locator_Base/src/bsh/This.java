...
public final class This implements java.io.Serializable, Runnable
{
	 ...
	 * 
	 * @param callstack
	 *            if callStack is null a new CallStack will be created and initialized with this namespace.
	 * @param declaredOnly
	 *            if true then only methods declared directly in the namespace will be visible - no inherited or imported methods will be
	 *            visible.
	 * @see bsh.Primitive
	 */
	/*
