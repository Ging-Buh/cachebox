...
public class Interpreter implements Runnable, ConsoleInterface, Serializable {
	 ...
	 * 
	 * @param namespace
	 *            If namespace is non-null then this interpreter's root namespace will be set to the one provided. If it is null a new one
	 *            will be created for it.
	 * @param parent
	 *            The parent interpreter if this interpreter is a child of another. May be null. Children share a BshClassManager with their
	 *            parent instance.
	 ...
	 * 
	 * @param sourceFileInfo
	 *            is for information purposes only. It is used to display error messages (and in the future may be made available to the
	 *            script).
	 * @throws EvalError
	 *             on script problems
	 * @throws TargetError
