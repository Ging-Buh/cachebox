...
class BSHArrayDimensions extends SimpleNode {
	...
	/**
	 * The Length in each defined dimension. This value set by the eval() Since the values can come from Expressions we should be re-eval()d
	 * each time.
	 */
	...
	/**
	 * Evaluate the structure of the array in one of two ways: a) an initializer exists, evaluate it and return the fully constructed array
	 * object, also record the dimensions of that array b) evaluate and record the lengths in each dimension and return void. The structure
	 * of the array dims is maintained in dimensions.
	 */
	@Override
	@SuppressWarnings("rawtypes")
