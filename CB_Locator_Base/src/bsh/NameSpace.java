 ...
 * of some bsh commands. However for normal use you should be using methods on bsh.Interpreter to interact with your scripts.
 * <p>
 * A bsh.This object is a thin layer over a NameSpace that associates it with an Interpreter instance. Together they comprise a Bsh scripted
 * object context.
 * <p>
 */
/*
...
public class NameSpace implements Serializable, BshClassManager.Listener, NameSource, Cloneable
{
	...
	*/
	 ...
	 * variables with primitive values you will have to wrap them using bsh.Primitive.
	 * 
	 * @see bsh.Primitive <p>
	 ...
	 * 
	 * @param recurse
	 *            If recurse is true then we recursively search through parent namespaces for the variable.
	 *            <p>
	 ...
	 * @param declaredOnly
	 *            if true then only methods declared directly in this namespace will be found and no inherited or imported methods will be
	 *            visible.
	 */
	@SuppressWarnings("rawtypes")
	 ...
	 * 
	 * @throws UtilEvalError
	 *             on error in parsing the script or if the the method is not found after parsing the script.
	 */
	/*
