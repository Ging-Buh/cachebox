...
class BSHTryStatement extends SimpleNode
{
	...
	public Object eval(CallStack callstack, Interpreter interpreter) throws EvalError
	{
		...
		/*
		 * Evaluate the contents of the try { } block and catch any resulting TargetErrors generated by the script. We save the callstack
		 * depth and if an exception is thrown we pop back to that depth before contiuing. The exception short circuited any intervening
		 * method context pops.
		 * 
