...
public class Type {
     ...
     *
     * @return {@link #VOID VOID}, {@link #BOOLEAN BOOLEAN}, {@link #CHAR CHAR}, {@link #BYTE BYTE}, {@link #SHORT SHORT}, {@link #INT INT},
     * {@link #FLOAT FLOAT}, {@link #LONG LONG}, {@link #DOUBLE DOUBLE}, {@link #ARRAY ARRAY} or {@link #OBJECT OBJECT}.
     */
     ...
     *
     * @return the fully qualified name of the class corresponding to this object type.
     */
    ...
    /**
     * Returns the internal name of the class corresponding to this object type. The internal name of a class is its fully qualified name,
     * where '.' are replaced by '/'. * This method should only be used for an object type.
     *
     ...
     *
     * @return the size of values of this type, i.e., 2 for <tt>long</tt> and <tt>double</tt>, and 1 otherwise.
     */
     ...
     *
     * @param opcode a JVM instruction opcode. This opcode must be one of ILOAD, ISTORE, IALOAD, IASTORE, IADD, ISUB, IMUL, IDIV, IREM, INEG,
     *               ISHL, ISHR, IUSHR, IAND, IOR, IXOR and IRETURN.
     * @return an opcode that is similar to the given opcode, but adapted to this Java type. For example, if this type is <tt>float</tt> and
