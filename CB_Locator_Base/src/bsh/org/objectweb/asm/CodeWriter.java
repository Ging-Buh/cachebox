...
/**
 * A {@link CodeVisitor CodeVisitor} that generates Java bytecode instructions. Each visit method of this class appends the bytecode
...
public class CodeWriter implements CodeVisitor {
    ...
    /**
     * The stack size variation corresponding to each JVM instruction. This stack variation is equal to the size of the values produced by
     * an instruction, minus the size of the values consumed by this instruction.
     */

    private final static int[] SIZE;
    /**
     * The shared pool of {@link Edge Edge} objects. This pool is a linked list of Edge objects, linked to each other by their
     * {@link Edge#poolNext} field.
     */
    ...
    static {
         ...
         *
         * b = new int[] { 0, //NOP, // visitInsn 1, //ACONST_NULL, // - 1, //ICONST_M1, // - 1, //ICONST_0, // - 1, //ICONST_1, // - 1,
         * //ICONST_2, // - 1, //ICONST_3, // - 1, //ICONST_4, // - 1, //ICONST_5, // - 2, //LCONST_0, // - 2, //LCONST_1, // - 1,
         * //FCONST_0, // - 1, //FCONST_1, // - 1, //FCONST_2, // - 2, //DCONST_0, // - 2, //DCONST_1, // - 1, //BIPUSH, // visitIntInsn 1,
         * //SIPUSH, // - 1, //LDC, // visitLdcInsn NA, //LDC_W, // - NA, //LDC2_W, // - 1, //ILOAD, // visitVarInsn 2, //LLOAD, // - 1,
         * //FLOAD, // - 2, //DLOAD, // - 1, //ALOAD, // - NA, //ILOAD_0, // - NA, //ILOAD_1, // - NA, //ILOAD_2, // - NA, //ILOAD_3, // -
         * NA, //LLOAD_0, // - NA, //LLOAD_1, // - NA, //LLOAD_2, // - NA, //LLOAD_3, // - NA, //FLOAD_0, // - NA, //FLOAD_1, // - NA,
         * //FLOAD_2, // - NA, //FLOAD_3, // - NA, //DLOAD_0, // - NA, //DLOAD_1, // - NA, //DLOAD_2, // - NA, //DLOAD_3, // - NA,
         * //ALOAD_0, // - NA, //ALOAD_1, // - NA, //ALOAD_2, // - NA, //ALOAD_3, // - -1, //IALOAD, // visitInsn 0, //LALOAD, // - -1,
         * //FALOAD, // - 0, //DALOAD, // - -1, //AALOAD, // - -1, //BALOAD, // - -1, //CALOAD, // - -1, //SALOAD, // - -1, //ISTORE, //
         * visitVarInsn -2, //LSTORE, // - -1, //FSTORE, // - -2, //DSTORE, // - -1, //ASTORE, // - NA, //ISTORE_0, // - NA, //ISTORE_1, //
         * - NA, //ISTORE_2, // - NA, //ISTORE_3, // - NA, //LSTORE_0, // - NA, //LSTORE_1, // - NA, //LSTORE_2, // - NA, //LSTORE_3, // -
         * NA, //FSTORE_0, // - NA, //FSTORE_1, // - NA, //FSTORE_2, // - NA, //FSTORE_3, // - NA, //DSTORE_0, // - NA, //DSTORE_1, // - NA,
         * //DSTORE_2, // - NA, //DSTORE_3, // - NA, //ASTORE_0, // - NA, //ASTORE_1, // - NA, //ASTORE_2, // - NA, //ASTORE_3, // - -3,
         * //IASTORE, // visitInsn -4, //LASTORE, // - -3, //FASTORE, // - -4, //DASTORE, // - -3, //AASTORE, // - -3, //BASTORE, // - -3,
         * //CASTORE, // - -3, //SASTORE, // - -1, //POP, // - -2, //POP2, // - 1, //DUP, // - 1, //DUP_X1, // - 1, //DUP_X2, // - 2,
         * //DUP2, // - 2, //DUP2_X1, // - 2, //DUP2_X2, // - 0, //SWAP, // - -1, //IADD, // - -2, //LADD, // - -1, //FADD, // - -2, //DADD,
         * // - -1, //ISUB, // - -2, //LSUB, // - -1, //FSUB, // - -2, //DSUB, // - -1, //IMUL, // - -2, //LMUL, // - -1, //FMUL, // - -2,
         * //DMUL, // - -1, //IDIV, // - -2, //LDIV, // - -1, //FDIV, // - -2, //DDIV, // - -1, //IREM, // - -2, //LREM, // - -1, //FREM, //
         * - -2, //DREM, // - 0, //INEG, // - 0, //LNEG, // - 0, //FNEG, // - 0, //DNEG, // - -1, //ISHL, // - -1, //LSHL, // - -1, //ISHR,
         * // - -1, //LSHR, // - -1, //IUSHR, // - -1, //LUSHR, // - -1, //IAND, // - -2, //LAND, // - -1, //IOR, // - -2, //LOR, // - -1,
         * //IXOR, // - -2, //LXOR, // - 0, //IINC, // visitIincInsn 1, //I2L, // visitInsn 0, //I2F, // - 1, //I2D, // - -1, //L2I, // -
         * -1, //L2F, // - 0, //L2D, // - 0, //F2I, // - 1, //F2L, // - 1, //F2D, // - -1, //D2I, // - 0, //D2L, // - -1, //D2F, // - 0,
         * //I2B, // - 0, //I2C, // - 0, //I2S, // - -3, //LCMP, // - -1, //FCMPL, // - -1, //FCMPG, // - -3, //DCMPL, // - -3, //DCMPG, //
         * - -1, //IFEQ, // visitJumpInsn -1, //IFNE, // - -1, //IFLT, // - -1, //IFGE, // - -1, //IFGT, // - -1, //IFLE, // - -2,
         * //IF_ICMPEQ, // - -2, //IF_ICMPNE, // - -2, //IF_ICMPLT, // - -2, //IF_ICMPGE, // - -2, //IF_ICMPGT, // - -2, //IF_ICMPLE, // -
         * -2, //IF_ACMPEQ, // - -2, //IF_ACMPNE, // - 0, //GOTO, // - 1, //JSR, // - 0, //RET, // visitVarInsn -1, //TABLESWITCH, //
         * visiTableSwitchInsn -1, //LOOKUPSWITCH, // visitLookupSwitch -1, //IRETURN, // visitInsn -2, //LRETURN, // - -1, //FRETURN, // -
         * -2, //DRETURN, // - -1, //ARETURN, // - 0, //RETURN, // - NA, //GETSTATIC, // visitFieldInsn NA, //PUTSTATIC, // - NA,
         * //GETFIELD, // - NA, //PUTFIELD, // - NA, //INVOKEVIRTUAL, // visitMethodInsn NA, //INVOKESPECIAL, // - NA, //INVOKESTATIC, // -
         * NA, //INVOKEINTERFACE, // - NA, //UNUSED, // NOT VISITED 1, //NEW, // visitTypeInsn 0, //NEWARRAY, // visitIntInsn 0,
         * //ANEWARRAY, // visitTypeInsn 0, //ARRAYLENGTH, // visitInsn NA, //ATHROW, // - 0, //CHECKCAST, // visitTypeInsn 0, //INSTANCEOF,
         * // - -1, //MONITORENTER, // visitInsn -1, //MONITOREXIT, // - NA, //WIDE, // NOT VISITED NA, //MULTIANEWARRAY, //
         * visitMultiANewArrayInsn -1, //IFNULL, // visitJumpInsn -1, //IFNONNULL, // - NA, //GOTO_W, // - NA, //JSR_W, // - }; for (i = 0;
         * i < b.length; ++i) { System.err.print((char)('E' + b[i])); } System.err.println();
         */
    }
    ...
    /**
     * The exceptions that can be thrown by this method. More precisely, this array contains the indexes of the constant pool items that
    ...
    /**
     * The (relative) stack size after the last visited instruction. This size is relative to the beginning of the current basic block,
     * i.e., the true stack size after the last visited instruction is equal to the {@link Label#beginStackSize beginStackSize} of the
     ...
     * block, i.e., the true maximum stack size after the last visited instruction is equal to the {@link Label#beginStackSize
    ...
    /**
     * The basic block stack used by the control flow analysis algorithm. This stack is represented by a linked list of {@link Label Label}
     * objects, linked to each other by their {@link Label#next} field. This stack must not be confused with the JVM stack used to execute
     * the JVM instructions!
     */

    private Label blockStack;
    /**
     * The head of the list of {@link Edge Edge} objects used by this {@link CodeWriter CodeWriter}. These objects, linked to each other by
     * their {@link Edge#poolNext} field, are added back to the shared pool at the end of the control flow analysis algorithm.
     */
    ...
    // --------------------------------------------------------------------------
    /**
     * The tail of the list of {@link Edge Edge} objects used by this {@link CodeWriter CodeWriter}. These objects, linked to each other by
     * their {@link Edge#poolNext} field, are added back to the shared pool at the end of the control flow analysis algorithm.
     */
     ...
     * @return the size of the arguments of the method (plus one for the implicit this argument), argSize, and the size of its return value,
     * retSize, packed into a single int i = <tt>(argSize << 2) | retSize</tt> (argSize is therefore equal to <tt>i >> 2</tt>, and
     ...
     * <p>
     * Note: it is possible to have several entries for the same instruction in the <tt>indexes</tt> and <tt>sizes</tt>: two entries
     * (index=a,size=b) and (index=a,size=b') are equivalent to a single entry (index=a,size=b+b').
     *
     * @param indexes current positions of the instructions to be resized. Each instruction must be designated by the index of its <i>last</i>
     *                byte, plus one (or, in other words, by the index of the <i>first</i> byte of the <i>next</i> instruction).
     * @param sizes   the number of bytes to be <i>added</i> to the above instructions. More precisely, for each i < <tt>len</tt>,
     *                <tt>sizes</tt>[i] bytes will be added at the end of the instruction designated by <tt>indexes</tt>[i] or, if
     *                <tt>sizes</tt>[i] is negative, the <i>last</i> |<tt>sizes[i]</tt>| bytes of the instruction will be removed (the
    ...
    /**
     * Resizes the designated instructions, while keeping jump offsets and instruction addresses consistent. This may require to resize
     * other existing instructions, or even to introduce new instructions: for example, increasing the size of an instruction by 2 at the
     * middle of a method can increases the offset of an IFEQ instruction from 32766 to 32768, in which case IFEQ 32766 must be replaced
     * with IFNEQ 8 GOTO_W 32765. This, in turn, may require to increase the size of another jump instruction, and so on... All these
     * operations are handled automatically by this method.
     * <p>
     * <i>This method must be called after all the method that is being built has been visited</i>. In particular, the {@link Label Label}
     ...
     *                <tt>sizes</tt>[i] bytes will be added at the end of the instruction designated by <tt>indexes</tt>[i] or, if
     *                <tt>sizes</tt>[i] is negative, the <i>last</i> |<tt>sizes[i]</tt>| bytes of the instruction will be removed (the
     *                instruction size <i>must not</i> become negative or null). The gaps introduced by this method must be filled in "manually"
     *                in the array returned by the {@link #getCode getCode} method.
     * @param len     the number of instruction to be resized. Must be smaller than or equal to <tt>indexes</tt>.length and <tt>sizes</tt>
     *                .length.
     * @return the <tt>indexes</tt> array, which now contains the new positions of the resized instructions (designated as above).
     */
    ...
    /**
     * Returns the current size of the bytecode of this method. This size just includes the size of the bytecode instructions: it does not
     * include the size of the Exceptions, LocalVariableTable, LineNumberTable, Synthetic and Deprecated attributes, if present.
     *
    ...
    /**
     * Returns the current bytecode of this method. This bytecode only contains the instructions: it does not include the Exceptions,
     * LocalVariableTable, LineNumberTable, Synthetic and Deprecated attributes, if present.
     *
     * @return the current bytecode of this method. The bytecode is contained between the index 0 (inclusive) and the index
