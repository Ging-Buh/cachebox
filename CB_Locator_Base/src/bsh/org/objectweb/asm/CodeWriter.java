...
public class CodeWriter implements CodeVisitor
{
	 ...
	 * 
	 * @param indexes
	 *            current positions of the instructions to be resized. Each instruction must be designated by the index of its <i>last</i>
	 *            byte, plus one (or, in other words, by the index of the <i>first</i> byte of the <i>next</i> instruction).
	 * @param sizes
	 *            the number of bytes to be <i>added</i> to the above instructions. More precisely, for each i &lt; <tt>len</tt>,
	 ...
	 * @param len
	 *            the number of instruction to be resized. Must be smaller than or equal to <tt>indexes</tt>.length and <tt>sizes</tt>
	 *            .length.
