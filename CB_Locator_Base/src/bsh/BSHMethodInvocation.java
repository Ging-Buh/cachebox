...
class BSHMethodInvocation extends SimpleNode
{
	...
	public Object eval(CallStack callstack, Interpreter interpreter) throws EvalError
	{
		...
		if (namespace.getParent() != null && namespace.getParent().isClass
				&& (nameNode.text.equals("super") || nameNode.text.equals("this"))) return Primitive.VOID;
		...
		catch (InvocationTargetException e)
		{
			...
			/*
			 * Try to squeltch the native code stack trace if the exception was caused by a reflective call back into the bsh interpreter
			 * (e.g. eval() or source()
			 */
