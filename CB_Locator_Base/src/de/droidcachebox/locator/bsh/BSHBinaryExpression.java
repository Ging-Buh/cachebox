...
class BSHBinaryExpression extends SimpleNode implements ParserConstants {
    ...
    public Object eval(CallStack callstack, Interpreter interpreter) throws EvalError {
        ...
        if (kind == INSTANCEOF) {
             ...
             */
            /*
             * Primitive (number or void) is not normally an instanceof anything. But for internal use we'll test true for the de.droidcachebox.locator.bsh.Primitive
             * class. i.e. (5 instanceof de.droidcachebox.locator.bsh.Primitive) will be true
             */
