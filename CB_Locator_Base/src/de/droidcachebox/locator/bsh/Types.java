...
class Types {
     ...
     * @param fromValue an Object or de.droidcachebox.locator.bsh.Primitive primitive value (including Primitive.NULL or Primitive.VOID )
     * @see #isBshAssignable(Class, Class)
     */
    @SuppressWarnings("rawtypes")
     ...
     * <p/>
     *
     * @param toType    the class type of the cast result, which may include primitive types, e.g. Byte.TYPE. toType may be null to indicate a
     *                  loose type assignment (which matches any fromType).
     * @param fromType  is the class type of the value to be cast including java primitive TYPE classes for primitives. If fromValue is (or would
     *                  be) Primitive.NULL then fromType should be null.
     * @param fromValue an Object or de.droidcachebox.locator.bsh.Primitive primitive value (including Primitive.NULL or Primitive.VOID )
     * @param checkOnly If checkOnly is true then fromValue must be null. FromType is checked for the cast to toType... If checkOnly is false then
    ...
    private static Object castObject(Class<?> toType, Class<?> fromType, Object fromValue, int operation, boolean checkOnly) throws UtilEvalError {
        ...
        // Can we use the proxy mechanism to cast a de.droidcachebox.locator.bsh.This to
