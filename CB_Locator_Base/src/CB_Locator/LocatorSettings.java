...
public interface LocatorSettings {
	...
	public static final SettingString MapsforgeDayStyle = new SettingString("MapsforgeDayStyle", SettingCategory.Map, NEVER, "", SettingStoreType.Global, SettingUsage.ACB);
	public static final SettingString MapsforgeNightStyle = new SettingString("MapsforgeNightStyle", SettingCategory.Map, NEVER, "", SettingStoreType.Global, SettingUsage.ACB);
	public static final SettingString MapsforgeCarDayStyle = new SettingString("MapsforgeCarDayStyle", SettingCategory.Map, NEVER, "", SettingStoreType.Global, SettingUsage.ACB);
	public static final SettingString MapsforgeCarNightStyle = new SettingString("MapsforgeCarNightStyle", SettingCategory.Map, NEVER, "", SettingStoreType.Global, SettingUsage.ACB);

	public static final SettingString UserMap1 = new SettingString("UserMap1", SettingCategory.Map, EXPERT, "http://services.arcgisonline.com/ArcGIS/rest/services/World_Imagery/MapServer/tile/{z}/{y}/{x}", SettingStoreType.Global, SettingUsage.ALL);
	public static final SettingString UserMap2 = new SettingString("UserMap2", SettingCategory.Map, EXPERT, "", SettingStoreType.Global, SettingUsage.ALL);
