...
public interface LocatorSettings {
	...
	public static final SettingString UserMap1 = (SettingString) SettingsList
			.addSetting(new SettingString("UserMap1", SettingCategory.Map, EXPERT, "http://services.arcgisonline.com/ArcGIS/rest/services/World_Imagery/MapServer/tile/{z}/{y}/{x}", SettingStoreType.Global, SettingUsage.ALL));
