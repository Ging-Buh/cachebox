...
public class FileIO
{
	...
	/**
	 * �berpr�ft ob ein File exestiert! <br>
	 * Und nicht �lter als die angegebene Zeit in Minuten ist!
	 * 
	 * @param filename
	 * @param maxAge
	 * @return true, wenn das File Exestiert und das Alter nicht gr��er als {maxAge} ist, ansonsten false.
	 */
