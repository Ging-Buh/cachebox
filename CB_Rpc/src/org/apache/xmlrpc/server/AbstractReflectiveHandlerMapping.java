...
public abstract class AbstractReflectiveHandlerMapping implements XmlRpcListableHandlerMapping {
    ...
    protected XmlRpcHandler newXmlRpcHandler(final Class pClass, final Method[] pMethods) throws XmlRpcException {
        ...
        if (sig == null || help == null) {
            return new ReflectiveXmlRpcHandler(this, typeConverterFactory, pClass, factory, pMethods);
        }
        return new ReflectiveXmlRpcMetaDataHandler(this, typeConverterFactory, pClass, factory, pMethods, sig, help);
    }
    ...
    public String[] getListMethods() throws XmlRpcException {
        ...
        for (Iterator iter = handlerMap.entrySet().iterator(); iter.hasNext(); ) {
            Map.Entry entry = (Map.Entry) iter.next();
