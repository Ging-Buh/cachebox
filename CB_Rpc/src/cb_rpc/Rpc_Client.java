...
public class Rpc_Client
{
	...
	/**
	 * Sendet eine XmlRpc-Nachricht an den RPC-Server und liefert dessen Antwort zurück
	 * 
	 * @param message
	 * @return
	 */
	...
	{
		if (client == null) createRpcConfig();
		if (client == null)
		{
		...
		try
		{
			...
			Object obj = client.execute("Rpc_Functions.Msg", new Object[]
				{ message });
